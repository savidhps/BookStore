          ...
          <div className="md:grid grid-cols-3 w-full">
            ...
            <div className="text-white flex justify-center items-center flex-col px-5">
              ...
              <div className="flex mt-10 w-full">
                <input className="py-2 px-4 bg-white rounded-3xl placeholder-gray-400 w-full" type="text" placeholder="search box" />
                <FontAwesomeIcon className="text-blue-800" style={{ marginTop: '11px', marginLeft: "-30px" }} icon={faMagnifyingGlass} />
              </div>
            </div>
            <div></div>
          </div>
